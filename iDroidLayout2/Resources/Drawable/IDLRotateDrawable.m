...
- (instancetype)initWithState:(IDLRotateDrawableConstantState *)state owner:(IDLRotateDrawable *)owner {
    self = [super init];
    if (self) {
        if (state != nil) {
...
- (instancetype)initWithState:(IDLRotateDrawableConstantState *)state {
    self = [super init];
    if (self) {
